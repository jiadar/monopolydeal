...
public class Deck {
  ...
  public Deck() {
    ...
    deck.add(
        new ActionCard(
            "Hotel",
            " Add onto any full set you own to add $4M to rent, excludes railroad & utilities",
            4));
    deck.add(
        new ActionCard(
            "Hotel",
    ...
    deck.add(
        new ActionCard(
            "House",
            "Add onto any full set you own to add $3M to rent, excludes railroad & utilities",
            3));
    deck.add(
        new ActionCard(
            "House",
    ...
    deck.add(
        new ActionCard(
            "Sly Deal",
            "Steal a property from a player of your choice, cannot be part of full set",
            3));
    deck.add(
        new ActionCard(
            "Sly Deal",
    ...
    RentCard w5 =
        new RentCard("Railroad / Utility", "Charge rent on Railroad or utility property", 1);
    w5.addColor("black");
    w5.addColor("ltgreen");
    deck.add(w5);
    ...
    RentCard w9 =
        new RentCard("Brown / Light Blue", "Charge rent on brown or light blue property", 1);
    w9.addColor("brown");
    w9.addColor("ltblue");
    deck.add(w9);
    ...
    WildCard wildcard4a =
        new WildCard("orange/purple Wild Card", "Use with orange/purple properties", 2);
    wildcard4a.addColor("orange");
    wildcard4a.addColor("purple");
    deck.add(wildcard4a);

    WildCard wildcard4b =
        new WildCard("organe/purple Wild Card", "Use with orange/purple properties", 2);
    wildcard4b.addColor("orange");
    wildcard4b.addColor("purple");
    deck.add(wildcard4b);

    WildCard wildcard5 =
        new WildCard("green/black Wild Card", "Use with green/black properties", 4);
    wildcard5.addColor("green");
    wildcard5.addColor("black");
    deck.add(wildcard5);

    WildCard wildcard6 =
        new WildCard("ltblue/black Wild Card", "Use with ltblue/black properties", 4);
    wildcard6.addColor("ltblue");
    wildcard6.addColor("black");
    deck.add(wildcard6);

    WildCard wildcard7 =
        new WildCard("ltgreen/black Wild Card", "Use with ltgreen/black properties", 2);
